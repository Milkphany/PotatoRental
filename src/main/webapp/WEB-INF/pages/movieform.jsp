...
<div id="wrap">
    ...
    <div id="moviepagebody">
        ...
        <div class="content">
            <form:form modelAttribute="movieId" cssClass="mainmovie" action="/movies/${movie.id}/done" method="post">
                <span class="header1"><form:input path="name" id="" type="text" value="${movie.name}" /></span>
                <sec:authorize access="hasRole('ROLE_MANAGER')">
                    <button type="submit" style="float:right">Done</button>
                </sec:authorize>
                ...
                <p>
                    <strong>Genre:</strong> <a href="#"><form:input path="type" type="text" value="${movie.type}" /></a>
                </p>
