            ...
            <div class="content">
                ...
                <dl class ="accordion">
                    ...
                    <dd>
                        ...
                        <strong>Editing/Deleting Movies:</strong> Navigate to movie page. Click Edit in top left corner. Then click Delete to remove movie.
                    </p>
                    </dd>
                    ...
                    <dd>
                        <div id="code">
                            ...
                            <p>
                                PROCEDURE record_order (datetime DATETIME, returndate DATE, account_id INTEGER, employ_id INTEGER, movie_id INTEGER)<br/>
                                BEGIN<br/>
