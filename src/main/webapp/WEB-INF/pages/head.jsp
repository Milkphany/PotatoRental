...
<link rel="stylesheet" type="text/css" href="css/potato.css"/>
...
<script type="text/javascript" src="js/jquery-scrolltofixed.jq"></script>
<script type="text/javascript" src="js/jquery-scrolltofixed-min.jq"></script>
